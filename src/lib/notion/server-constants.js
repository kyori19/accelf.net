...
const PAGES_INDEX_ID = normalizeId(process.env.PAGES_INDEX_ID)
const PAGES_INDEX_CACHE = path.resolve('.pages_index_cache')

const SOURCES = {
  blog: {
    index: BLOG_INDEX_ID,
    cache: BLOG_INDEX_CACHE,
  },
  pages: {
    index: PAGES_INDEX_ID,
    cache: PAGES_INDEX_CACHE,
  },
}
